...
#ifndef NAV2_BT_NAVIGATOR__NAVIGATORS__FOLLOW_POINT_HPP_
#define NAV2_BT_NAVIGATOR__NAVIGATORS__FOLLOW_POINT_HPP_
...
public:
  ...
  /**
   * @brief A constructor for FollowPointNavigator
   */
  FollowPointNavigator()
  : Navigator() {}
   ...
   */
  void onFollowPointReceived(const geometry_msgs::msg::PoseStamped::SharedPtr pose);

  /**
   * @brief Get action name for this navigator
   * @return string Name of action server
   */
  std::string getName() override {return std::string("follow_point");}
...
#endif  // NAV2_BT_NAVIGATOR__NAVIGATORS__FOLLOW_POINT_HPP_
